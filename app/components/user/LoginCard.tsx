...
const LoginCard = ({ role, action }: LoginCard) => {
  return (
    <form
      className="min-w-[400px] p-6 flex justify-center flex-col items-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
      action={action}>
